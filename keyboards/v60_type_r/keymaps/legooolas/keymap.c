...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_60_ansi(
	       ...
	       KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_VOLD,   KC_VOLU, KC_MUTE, KC_END,  KC_PGDN,  KC_DOWN,           KC_PGUP,  \
	       KC_TRNS,   KC_RALT,  KC_TRNS,            KC_TRNS,                                                  KC_TRNS,  KC_HOME, KC_PGDN, KC_END),
